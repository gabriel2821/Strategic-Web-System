...
return new class extends Migration
{
    ...
    {
        Schema::create('archived_program_rows', function (Blueprint $table) {
            $table->id();
            $table->foreignId('program_id')->constrained('archived_programs')->onDelete('cascade'); //fk program_id
    ...
    {
        Schema::dropIfExists('archived_program_rows');
    }
};
